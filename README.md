...
1. _relational database (sql ,tables)_
2. _hierarchial database (nosql)_
3. _network (neo-4 j)_
4. _object oriented _
   ##ER -diagram
...
these function are used wildcard (in , any, all )
...
- soundex ( for simalr sound) select soundex(bill),sounddex(bell) - select 'bill' sounds like 'boil', sounds like ' bill' sounds ' phil'
